...
export default function AgaonEngine() {
  ...
  return (
    <section
      id="technology"
      className="py-24 bg-[#111844] text-white relative overflow-hidden"
    >
      {" "}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="max-w-3xl mb-20">
          ...
          <p className="mt-4 text-slate-400 text-base md:text-lg leading-relaxed">
            {" "}
            We operate like a physics laboratory. Our hardware, site
            diagnostics, and materials-science divisions replace guessing with
            absolute, digital certainty.{" "}
          </p>{" "}
        </div>{" "}
        {/* Dashboard Frame */}{" "}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 bg-[#0D2248]/40 border border-[#0D2248] rounded-3xl p-6 md:p-10 backdrop-blur-md">
            ...
            {METHODOLOGIES.map((method) => {
              ...
              return (
                <button
                  ...
                  className={`group text-left px-6 py-5 rounded-2xl transition-all duration-300 flex items-center justify-between border cursor-pointer ${isActive ? "bg-[#111844] text-white border-[#4B5694] shadow-lg" : "bg-[#111844]/30 text-slate-400 hover:text-white border-transparent hover:bg-[#111844]/50"}`}
                >
                  {" "}
                  <div className="space-y-1">
                    {" "}
                    <span className="block font-mono text-sm uppercase tracking-widest text-[#4B5694]">
                      {" "}
                      R&D Protocols{" "}
                    </span>{" "}
                  ...
                  <ChevronRight
                    className={`w-5 h-5 transition-transform duration-300 ${isActive ? "text-[#4B5694] translate-x-1" : "text-slate-600 group-hover:text-slate-400"}`}
                  />{" "}
                </button>
              );
            })}{" "}
          ...
          <div className="lg:col-span-8 bg-[#111844]/80 border border-[#0D2248]/80 rounded-2xl p-8 md:p-10 min-h-[500px] flex flex-col justify-between">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pb-6 border-b border-[#0D2248]">
                  ...
                  <div>
                    {" "}
                    <span className="inline-block px-3 py-1 bg-white/5 border border-white/10 text-[#4B5694] font-mono text-sm uppercase rounded-full mb-2">
                      {" "}
                  ...
                  <div className="bg-[#0D2248] border border-[#4B5694]/20 px-6 py-4 rounded-xl flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <span className="block font-mono text-sm text-slate-400 uppercase tracking-widest">
                        {" "}
                ...
                <div className="space-y-4">
                  {" "}
                  <p className="text-[#4B5694] font-sans font-semibold text-sm">
                ...
                <div className="space-y-3">
                  {" "}
                  <span className="block font-mono text-sm uppercase tracking-widest text-slate-400">
                    {" "}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                    ...
                    {activeMethod.benefits.map((benefit, idx) => (
                      <div
                        key={idx}
                        className="flex items-start bg-[#0D2248]/20 p-3 rounded-lg border border-[#0D2248]/50"
                      >
                        {" "}
                        <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mr-3 mt-0.5" />{" "}
                        <span className="text-slate-300 font-sans text-sm leading-normal">
                          {" "}
                          {benefit}{" "}
                        </span>{" "}
                      </div>
            ...
            {/* Scientific footer */}{" "}
            <div className="mt-8 pt-6 border-t border-[#0D2248] flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-sm">
              {" "}
