...
import { Home, Lightbulb, Grid, LayoutDashboard, ArrowRight } from 'lucide-react';
...
export default function ComprehensiveSolutions() {
  return (
    <section className="relative py-32 bg-[#111844] overflow-hidden">
      ...
      />
      <div className="absolute inset-0 z-0 pointer-events-none opacity-[0.015] mix-blend-overlay"
        style={{
          backgroundImage: `
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-24">
          ...
          >
            We manage the complete lifecycle of your project—from architectural conception to final interior execution.
          </motion.p>
        </div>
