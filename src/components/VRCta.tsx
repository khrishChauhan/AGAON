    ...
    >
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-6 md:px-12 text-center flex flex-col items-center">
        ...
        <motion.h2
          ...
          className="font-display text-5xl md:text-7xl font-extrabold tracking-tight text-white leading-[1.1] mb-8"
        >
          {" "}
          See the Future.
          <br />{" "}
          <span className="text-white/60 font-light">Literally.</span>{" "}
        </motion.h2>{" "}
        {/* Description */}{" "}
        <motion.p
        ...
        >
          {" "}
          Take a test drive of your home in Virtual Reality before a single
          brick is laid.{" "}
        </motion.p>{" "}
        {/* CTA Button */}{" "}
        <motion.div
        ...
        >
          ...
          <button className="relative px-10 py-5 bg-white rounded-none overflow-hidden flex items-center space-x-6 border border-transparent hover:border-[#4B5694]/50 transition-all duration-500 shadow-[0_20px_40px_rgba(0,0,0,0.4)] group-hover:shadow-[0_20px_40px_rgba(255,107,44,0.2)] transform group-hover:-translate-y-1">
            ...
            <span className="relative z-10 font-sans font-bold text-sm uppercase tracking-widest text-[#111844] group-hover:text-white transition-colors duration-300">
              {" "}
