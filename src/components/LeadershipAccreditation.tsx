...
import { ShieldCheck, Award, GraduationCap, ArrowUpRight, Scale } from 'lucide-react';
...
const ACCREDITATIONS = [
  ...
  },
  {
    ...
    summary: 'Integration of renewable local microgrids, passive solar envelope structures, and eco-friendly foundations.',
    accent: '#47d1a0'
  },
  {
    title: 'Seismic Class A',
    agency: 'Global Earthquake Safety Panel',
    summary: 'Comprehensive validation of tuned pendulum mass dampers and base rubberised core isolation elements.',
    accent: '#2f81f7'
  },
  {
    title: 'IGBC Green Cement',
    agency: 'Indian Green Building Council',
    summary: 'Full environmental clearance for low-carbon E-Crete™ formulation, minimizing net clinker weight metrics.',
    accent: '#10b981'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="mt-4 text-slate-400 text-base md:text-lg leading-relaxed">
            Our operational panel integrates advanced structural physics degrees from the world&apos;s leading institutions with decades of active high-rise site orchestration.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <p className="text-slate-400 font-sans text-sm md:text-base leading-relaxed">
                Agaon refuses to operate under basic regional building guidelines. Every foundation structure is pre-engineered to exceed sovereign regulatory tolerances, securing structural asset valuations for generations.
              </p>
              
              <div className="flex space-x-6 pt-2">
                <div>
                  <span className="block font-sans text-3xl font-extrabold text-white">100%</span>
                  <span className="block font-mono text-[10px] text-slate-500 uppercase tracking-widest mt-1">
                    BIM Digital-Twin Check
                  </span>
                </div>
                <div className="border-r border-white/10" />
                <div>
                  <span className="block font-sans text-3xl font-extrabold text-white">LEED</span>
                  <span className="block font-mono text-[10px] text-slate-500 uppercase tracking-widest mt-1">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <div
                        ...
                        style={{ backgroundColor: acc.accent, color: acc.accent }}
                      />
                    </div>
