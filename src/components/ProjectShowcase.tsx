        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-12">
          <div className="max-w-2xl">
            ...
            <h2 className="font-display text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-white leading-[1.05]">
              Generational<br />
              <span className="font-serif italic font-medium text-white/50">Structures.</span>
            </h2>
          </div>
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-4">
            {categories.map((cat) => (
              <button
                ...
                className={`text-[10px] uppercase font-bold tracking-[0.2em] pb-1 border-b border-white transition-all duration-300 cursor-pointer ${
          ...
          {filteredProjects.map((project, idx) => (
            ...
            >
              ...
              <div className="w-full lg:w-[35%] flex flex-col justify-center">
                <div className="flex items-center space-x-4 mb-6 text-white/50 text-[10px] font-sans uppercase tracking-[0.2em]">
                ...
                <div className="flex space-x-12 pt-8 border-t border-white/20 mb-10">
                  <div>
                    <span className="block font-sans text-[10px] text-white/40 tracking-[0.2em] uppercase mb-1">Scale</span>
                    <span className="block font-display text-lg text-white">{project.size}</span>
                  </div>
                  <div>
                    <span className="block font-sans text-[10px] text-white/40 tracking-[0.2em] uppercase mb-1">Delivery</span>
                    <span className="block font-display text-lg text-white">{project.completionYear}</span>
                  </div>
                </div>
