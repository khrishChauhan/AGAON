      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <header className="py-20 md:py-28 max-w-4xl">
          ...
          >
            ...
            <span className="text-[#4B5694] text-xs font-bold uppercase tracking-[0.2em]">ABOUT OUR MISSION</span>
          </motion.div>
          ...
          >
            Structuring the<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#111844] to-[#4B5694]/80 italic font-light">Unorganized.</span>
          </motion.h1>
          ...
          >
            Agaon Construction is on a mission to bring transparency, systematized workflows, and software-level precision to the Indian construction sector.
          </motion.p>
        </header>
          ...
          <div className="lg:col-span-6 flex flex-col justify-between h-full space-y-16">
            ...
            >
              <div className="flex items-center space-x-3">
                <span className="font-sans text-[10px] uppercase font-bold text-[#4B5694] tracking-[0.20em]">01 &mdash; PHILOSOPHY</span>
              </div>
              ...
              <div className="space-y-6 font-sans text-base md:text-lg text-[#7288AE]/70 font-light leading-relaxed">
                <p>
                  We recognized a massive trust deficit in the traditional contracting market.
                </p>
                <p>
                  Our goal is to transform construction from a stressful chore into a premium, transparent experience.
                </p>
                <div className="pl-6 border-l-2 border-[#4B5694] italic text-[#111844] font-medium">
                  We don't just build homes; we engineer peace of mind with our proprietary 500+ point inspection protocol.
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-3 mb-8">
                <span className="font-sans text-[10px] uppercase font-bold text-[#4B5694] tracking-[0.20em]">02 &mdash; ARCHITECTURAL METRICS</span>
              </div>
              
              <div className="grid grid-cols-2 gap-12">
                <div className="space-y-3">
                  <div className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-[#111844] tracking-tight flex items-baseline">
                    100%
                  </div>
                  <div className="w-10 h-[2px] bg-[#4B5694]" />
                  <span className="font-sans text-xs font-bold text-[#7288AE]/50 uppercase tracking-[0.15em] block">
                    Transparent Pricing
                  </span>
                </div>
