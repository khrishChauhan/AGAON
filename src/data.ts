...
export const PROJECTS: Project[] = [
  {
    ...
    category: "Commercial",
    description:
      "A magnificent 280-meter sky-scraping commercial headquarters in NCR featuring a dramatic twisted aerodynamic envelope and double-skin active breathing glass facade.",
    longDescription:
    ...
    specs: [
      {
        ...
        value: "Steel-Concrete Composite Exoskeleton",
      },
      { label: "Total Storeys", value: "68 Floors + 4 Sub-basements" },
      {
        label: "Facade Glazing",
        value: "Low-E Acoustic Argon Double-Glazed Unit",
      },
  ...
  },
  {
    ...
    description:
      "A private residential enclave of 12 bespoke architectural estates carved directly into the basalt cliffs of Alibaug, featuring striking cantilevered structures.",
    longDescription:
    ...
    specs: [
      ...
      {
        label: "Aggregate Material",
        value: "Recycled Ocean-Glass & Basalt Fines",
      },
      {
        label: "Glazing System",
        value: "Hurricane-Resistant 16mm Laminated Structural Glass",
      },
      {
        label: "Water Management",
        value: "Submerged Reverse-Osmosis Treatment Vault",
      },
      {
        label: "Smart Integration",
        value: "KNX Domotic Automation with Centric Hub",
      },
    ],
  },
  {
    ...
    category: "Industrial",
    description:
      "A massive 40-acre high-performance tech hub and server campus in Bangalore with specialized structural thermal dynamics and hyper-safe layouts.",
    longDescription:
    ...
    specs: [
      ...
      {
        label: "Acoustic Barrier",
        value: "Sound-absorption cladding with rating STC 65",
      },
      {
        label: "Redundant Power Vault",
        value: "Reinforced 450mm shear walls protection",
      },
    ],
  },
  {
    ...
    description:
      "An architectural 1.2-kilometer pre-cast pre-stressed express bridge over complex estuarine terrains, incorporating active sensor diagnostic networks.",
    longDescription:
    ...
    specs: [
      { label: "Bridge Type", value: "Precast Segmental Balanced Cantilever" },
      {
        ...
        value: "Deep Cast-in-Situ RC Piles (up to 45m depth)",
      },
      {
        label: "Structural Monitoring",
        value: "Fiber-optic Bragg grating continuous strain sensors",
      },
      {
        label: "Prestressing Steel",
        value: "High-tensile low-relaxation tendons (1860 MPa)",
      },
      {
        label: "Concrete Specification",
        value: "M60 Silica Fume High-Performance Concrete",
      },
    ],
  },
];
export const METHODOLOGIES: TechMethodology[] = [
  {
    ...
    shortDesc:
      "We move beyond standard CAD drawing. Our integrated 5D Building Information Modeling connects architectural, structural, and financial metrics in real-time.",
    longDesc:
      "By simulating every single component of the construction process in a digital twin environment before a single ounce of concrete is poured, we eradicate site surprises. Our 5D engine factors in real-time supply chain updates, heavy machinery schedules, and micro-climatic weather predictions, creating an absolute blueprint for flawless operational delivery.",
    benefits: [
    ...
    techSpec:
      "Autodesk BIM 360 Enterprise Sync with custom millimetric API interfaces",
  ...
  },
  {
    ...
    subtitle:
      "Maximizing spatial flexibility and dramatic architectural spans.",
    shortDesc:
      "We utilize state-of-the-art post-tensioning techniques with high-tensile steel cables inside concrete floor plates, allowing incredible column-free expanses.",
    longDesc:
  ...
  },
  {
    ...
    shortDesc:
      "Our proprietary concrete formulations incorporate high-volume pozzolans and active basalt micro-dust to curtail carbon footprint while achieving ultimate load capacity.",
    longDesc:
      "Traditional concrete is highly carbon-intensive. Our industrial engineering lab pioneered E-Crete™, which utilizes fly ash, ground-granulated blast-furnace slag, and captured carbon particles. The resulting mix actually gains strength faster than conventional cement and offers an ultra-dense structure resistant to chemical and environmental degradation.",
    benefits: [
    ...
    techSpec:
      "Integrated carbon-capture particle seeding with volcanic aggregate binders",
  ...
  },
  {
    ...
    shortDesc:
      "We inspect physical worksites using autonomous robotic units fitted with sub-millimeter grade LiDAR systems, instantly comparing physical builds with digital designs.",
    longDesc:
      "Every morning, our autonomous rovers map built progress down to 1mm resolution. Any minor offset, deflection in rebar, or structural misalignment is highlighted in red on our site dashboards before the next shift starts. This delivers ironclad assurance that your physical structure conforms precisely to engineering plans.",
    benefits: [
    ...
    techSpec:
      "Autonomous rovers with Leica Geosystems robotic grade laser scanning scanners",
